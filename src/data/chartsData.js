...
export const categoryChartData = [
     { name: "موبایل", value: 35, fill: "#3b82f6" },
     { name: "لپ‌تاپ", value: 28, fill: "#8b5cf6" },
     { name: "لوازم جانبی", value: 22, fill: "#ec4899" },
     { name: "مانیتور", value: 10, fill: "#f59e0b" },
     { name: "صوتی", value: 5, fill: "#10b981" },
];

// نمودار وضعیت سفارشات
export const orderStatusData = [
     { name: "تکمیل شده", value: 245, fill: "#10b981" },
     { name: "در حال پردازش", value: 127, fill: "#f59e0b" },
     { name: "در انتظار تایید", value: 63, fill: "#3b82f6" },
     { name: "لغو شده", value: 35, fill: "#ef4444" },
];

// نمودار رشد کاربران
export const userGrowthData = [
     { week: "هفته ۱", newUsers: 120, activeUsers: 890 },
     { week: "هفته ۲", newUsers: 145, activeUsers: 1035 },
     { week: "هفته ۳", newUsers: 98, activeUsers: 1133 },
     { week: "هفته ۴", newUsers: 178, activeUsers: 1311 },
     { week: "هفته ۵", newUsers: 156, activeUsers: 1467 },
];

// نمودار درآمد مقابل هزینه
export const revenueVsCostData = [
     { month: "فروردین", revenue: 4000, cost: 2400, profit: 1600 },
     { month: "اردیبهشت", revenue: 3200, cost: 1398, profit: 1802 },
     { month: "خرداد", revenue: 2800, cost: 1800, profit: 1000 },
     { month: "تیر", revenue: 3900, cost: 2108, profit: 1792 },
     { month: "مرداد", revenue: 3500, cost: 1800, profit: 1700 },
